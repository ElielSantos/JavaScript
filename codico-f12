...
const input = document.getElementById('answer166748X29X150');
...
const input = document.getElementById('answer166748X29X151');
...
const input = document.getElementById('answer392913X17X106');
